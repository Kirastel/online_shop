...
#         ('other', 'Other'),
#     ]
#     for_product = models.ManyToManyField(
#         Product,
#         related_name='Accs'
#     )
...
#     availability = models.CharField(
#         choices=[('In', 'In stock'), ('Out', 'Out stock')],
#         max_length=50, default='In stock'
#     )
...
#         null=True,
#         blank=True,
#         help_text='Ввод старой цены для отображения скидки на аксесуар'
#     )
#     append_date = models.DateTimeField(
#         auto_now_add=True,
#         auto_now=False,
...
#
#     def __str__(self):
#         return f'Акссесуар для {self.for_product}'
#
#     def availability_color(self):
#         if self.availability == 'In stock':
#             return '<font color="green">In stock</font>'
